...
return [
    'modules' => [
        ...
        'Emizen_Custom' => 1,
        'Emizen_CustomAttribute' => 1,
        'Emizen_Customemail' => 1,
        'Emizen_Restrictcountry' => 1,
        'Emizen_Synchannel' => 1,
        ...
        'Klarna_KpGraphQl' => 1,
        'MageBeans_Common' => 1,
        'MageBeans_Pageimage' => 1,
        'MageBeans_Stocklist' => 1,
        'Magebees_Navigationmenu' => 1,
        ...
        'Magmodules_Sooqr' => 1,
        'Mgt_Varnish' => 1,
        'Nadeem0035_AllowHtmlTag' => 1,
        'Nadeem0035_CategoryAttribute' => 1,
        'Nadeem0035_CategoryTab' => 1,
        'Nadeem0035_DisableCartCheckout' => 1,
        'Nadeem0035_General' => 1,
        'Nadeem0035_ImportData' => 1,
        'Nadeem0035_MachineSearch' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'PluginCompany_LicenseManager' => 1,
        'PluginCompany_ProductPdf' => 1,
        'RH_MultiSelectCategory' => 1,
        'Sparsh_Banner' => 0,
        'Tawk_Widget' => 1,
