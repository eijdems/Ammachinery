...
class Uploader extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Aktiv\Satisfiedcustomer\Model\ImageUploader $imageUploader,
    ...
    public function execute()
    {
        ...
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'image/image/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'image/image/';
