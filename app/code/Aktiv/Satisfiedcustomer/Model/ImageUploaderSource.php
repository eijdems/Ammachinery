 ...
 */
class ImageUploaderSource
{
    const IMAGE_TMP_PATH = 'sourceimage/sourceimage';
    /**
     * @var string
     */
    const IMAGE_PATH = 'sourceimage/sourceimage';

    const IMAGE_TYPE = ['jpg','jpeg','gif','png'];
    /**
    ...
    public function __construct(
        ...
        $allowedExtensions = self::IMAGE_TYPE,
        $allowedMimeTypes = []
    ) {
