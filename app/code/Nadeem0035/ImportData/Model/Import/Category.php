...
namespace Nadeem0035\ImportData\Model\Import;

use Nadeem0035\ImportData\Helper\Config;
use Nadeem0035\ImportData\Model\Enterprise\VersionFeaturesFactory;
use Nadeem0035\ImportData\Model\Import\Proxy\Category\ResourceModelFactory as CategoryResourceModelFactory;
use Nadeem0035\ImportData\ResourceModel\Import\Category\StorageFactory;
use Nadeem0035\ImportData\Model\Enterprise\CategoryImportVersion;
...
class Category extends \Magento\ImportExport\Model\Import\AbstractEntity
{
    ...
    /**
     * @var \Nadeem0035\ImportData\ResourceModel\Import\Category\StorageFactory
     */
     ...
     * Behavior can be turned off with config setting "importdata/general/clear_field_on_empty_string"
     * You can define a string which can be used for clearing a field, configured in "importdata/category/symbol_for_clear_field"
     *
     * @param array $rowData
     */
