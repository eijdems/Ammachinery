    ...
    $.widget('weltpixel.newsletterpopup', {
        ...
        _create: function () {
            ...
            if (!this.options.justCountPages) {
                ...
                var that = this;
                /*$('#weltpixel_newsletter').bind('submit', function(event) {
                    if ($(this).valid()) {
                        $("#message-popup").addClass("message success");
                        $("#message-popup").html("Thank you for your subscription");
                        that.closeCallback();
                    }
                });*/

                $("#weltpixel_newsletter").submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        { console.log(data);
                          $("#message-popup").html(data.json_data);
                        }
                    });  
                });
            } else {
        ...
        initPopup: function () {
            ...
            $('body').addClass("custom-poup-newsletter");
        ...
        closePopup: function () {
            ...
            $('body').removeClass("custom-poup-newsletter");
        },
