 ...
 */
namespace WeltPixel\Newsletter\Controller\Index;
 ...
 */
class Index extends SubscriberController implements HttpPostActionInterface
{
    /**
        ...
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            try {
                ...
                if ($subscriber->getId()
                    ...
                    $flag = 1;
                    $message =  "<span style='color:red'>".__('This email address is already subscribed.')."</span>";
                }
                else{
                ...
                $message = "<span style='color:red'>".__('Something went wrong with the subscription.')."</span>";
            }
        }
        
        return $resultJson->setData(['json_data' => $message,'flag' => $flag]);
