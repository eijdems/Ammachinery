<?php 
namespace MageBeans\Pageimage\Controller\Adminhtml\Cms\Page;
...
class Save extends \Magento\Cms\Controller\Adminhtml\Page\Save
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if(isset($data['extra_image']) && is_array($data['extra_image'])){
                $data['extra_image']=$data['extra_image'][0]['name'];
            }
