...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function getStaticTemplateDirectoryPath($dir_for_dynamic_file='pub/media/magebees/navigationmenu')
    {
		$rootPath = $this->filesystem->getDirectoryRead(\Magento\Framework\App\Filesystem\DirectoryList::ROOT)->getAbsolutePath().$dir_for_dynamic_file."/static/";
		return $rootPath;
    }
    public function getDynamicCSSDirectoryPath($dir_for_dynamic_file='pub/media/magebees/navigationmenu')	{
        $rootPath = $this->filesystem->getDirectoryRead(\Magento\Framework\App\Filesystem\DirectoryList::ROOT)->getAbsolutePath().$dir_for_dynamic_file."/css/";
		return $rootPath;
    }
