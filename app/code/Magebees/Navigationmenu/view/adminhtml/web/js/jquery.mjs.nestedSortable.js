...
$li.addClass(self.options.collapsedClass); } else {
$li.addClass(self.options.expandedClass); }
        ...
        _mouseDrag: function (event) {
			...
			var delta_vertical = this.positionAbs.top - this.lastPositionAbs.top;
            var delta_vertical_direction = (delta_vertical > 0) ? "down" : "up";
			this.dragDirection.vertical = delta_vertical_direction;
			var delta_horizontal = this.positionAbs.left - this.lastPositionAbs.left;
            delta_horizontal !== 0 && ( delta_horizontal > 0 ? "right" : "left" );
			var delta_horizontal_direction = (delta_horizontal > 0) ? "right" : "left";
			this.dragDirection.horizontal = delta_horizontal_direction;
